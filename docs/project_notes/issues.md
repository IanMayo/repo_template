...
| 2026-06-08 | PR #3 | Demo app + sample blog post; deploy no-blog-change fix; URL-derived PR-preview nav (no hardcoded base path) | [#3](https://github.com/IanMayo/repo_template/pull/3) |
