...
![One merge to main fans out through one deploy run to /, /app/, and /blog/](screenshots/hero.svg)
...
![The pipeline: one merge, one run, three published areas](screenshots/hero.svg)
